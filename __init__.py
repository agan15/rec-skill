...
class RecipeSkill(MycroftSkill):
    ...
    def __init__ (self):
       ...
       # self.set_context(self, "food")
    
    def initialize(self):
       # keyword_intent = IntentBuilder("RecipeKeywordIntent").\
           # require("RecipeKeyword").optionally("recipe").build()
        keyword_intent = IntentBuilder("RecipeKeywordIntent").\
            require("RecipeKeyword").require("recipe").build()
        needMore_intent = IntentBuilder("FoodTypeIntent").\
            require("FoodType").build()
    ...
    def handle_needMore(self, message):
        if self.ask:
            ...
            self.speak("rating is" + self.rec_name +"is" + str(rec.rating))
